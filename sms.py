...
subprocess.run(["curl", "-LOJ", "-o", "/sms/DbusSmsForward.zip",
                "https://ghproxy.com/https://github.com/lkiuyu/DbusSmsForward/releases/latest/download/DbusSmsForward.zip"])
...
subprocess.run(["curl", "-LOJ", "-o", "/sms/sms.zip",
                "https://ghproxy.com/https://raw.githubusercontent.com/Clunky1546/RES/main/sms.zip"])
